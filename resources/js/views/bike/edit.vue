...
export default {
  ...
  methods: {
      async loadBike() {
      axios.get("/api/bike/" + this.$route.params.id).then((res) => {
        this.bike = res.data;
        ...
        this.form.stroke              = res.data.stroke;
        ...
        this.form.fuel_reserve        = res.data.fuel_reserve;
        this.form.ground_clearance    = res.data.ground_clearance;
        ...
        this.form.wheelbase           = res.data.wheelbase;
        this.form.braking_system      = res.data.braking_system;
        this.form.front_brake         = res.data.front_brake;
        this.form.rear_brake          = res.data.rear_brake;
        this.form.front_tyre          = res.data.front_tyre;
        this.form.rear_tyre           = res.data.rear_tyre;
        this.form.chassis_type        = res.data.chassis_type;
        this.form.front_suspension    = res.data.front_suspension;
        this.form.rear_suspension     = res.data.rear_suspension;
        this.form.battery             = res.data.battery;
        this.form.head_light          = res.data.head_light;
        this.form.tail_light          = res.data.tail_light;
        this.form.indicator_light     = res.data.indicator_light;
        this.form.clock               = res.data.clock;
        this.form.engine_kill_switch  = res.data.engine_kill_switch;
        this.form.pass_light          = res.data.pass_light;
        this.form.speedometer         = res.data.speedometer;
        this.form.techometer          = res.data.techometer;
        this.form.gear_indicator      = res.data.gear_indicator;
        this.form.low_battery_indicato= res.data.low_battery_indicator;
        this.form.low_fuel_indicator  = res.data.low_fuel_indicator;
        this.form.launched_at         = res.data.launched_at;
        this.form.capacity_id         = res.data.capacity_id;
      ...
      updateBike(){
          axios.put("/api/bike/" + this.$route.params.id, this.form).then(res=>{
              this.$swal(
                        "Updated!",
