...
class BikeController extends Controller
{
    ...
    public  function  contentAdd(Request $request, $id)
    {
        $bike = Bike::findorfail($id);
        $bike->content = $request->bike_content;
        $bike->meta_keyword = $request->meta_keyword;
    ...
    {
        return Bike::findorfail($id, ['content', 'meta_keyword', 'meta_description']);
